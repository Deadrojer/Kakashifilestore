        ...
        try:      
            ...
            if is_banned:
                ...
                keyboard = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ ʜᴇʀᴇ...!!", url="https://t.me/Fire_Blood_Demon")]]
                )
...
async def not_joined(client: Client, message: Message):
    ...
    try:
        ...
        for chat_id in all_channels:
            ...
            if not is_member:
                try:
                    ...
                    await temp.edit(
                        f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇ @Fire_Blood_Demon</i></b>\n"
        ...
        await temp.edit(
            f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @Fire_Blood_Demon</i></b>\n"
            f"<blockquote expandable><b>Rᴇᴀsᴏɴ:</b> {e}</blockquote>"
        )
